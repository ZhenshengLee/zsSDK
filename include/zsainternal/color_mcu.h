...
#include <zsainternal/usbcommand.h>
 ...
 *
 * \return ZSA_RESULT_SUCCEEDED if the call succeeded
 */
...
zsa_result_t colormcu_imu_register_stream_cb(colormcu_t colormcu_handle,
                                             ...
                                             void *context);
zsa_result_t colormcu_imu_get_calibration(colormcu_t colormcu_handle,
