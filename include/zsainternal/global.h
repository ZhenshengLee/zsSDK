...
typedef void *zsa_init_once_t;
#define ZSA_INIT_ONCE                                                                                                  \
    {                                                                                                                  \
        0                                                                                                              \
    }

typedef void(zsa_init_once_function_t)(void);
 ...
 *
 */
#define ZSA_DECLARE_GLOBAL(_global_type_, _init_function_)                                                             \
    static zsa_init_once_t g_##_global_type_##_init_once = ZSA_INIT_ONCE;                                              \
