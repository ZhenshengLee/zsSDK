 ...
 */
typedef void(usb_cmd_stream_cb_t)(zsa_result_t result, zsa_image_t image_handle, void *context);
 ...
 */
zsa_buffer_result_t usb_cmd_get_serial_number(usbcmd_t usb_handle, char *serial_number, size_t *serial_number_size);

// Read command
zsa_result_t usb_cmd_read(usbcmd_t usb_handle,
                          uint32_t cmd,
                          uint8_t *p_cmd_data,
...
// Write command
zsa_result_t usb_cmd_write(usbcmd_t usb_handle,
                           uint32_t cmd,
                           uint8_t *p_cmd_data,
                           size_t cmd_data_size,
                           uint8_t *p_data,
...
zsa_result_t usb_cmd_write_with_status(usbcmd_t usb_handle,
                                       uint32_t cmd,
                                       uint8_t *p_cmd_data,
                                       size_t cmd_data_size,
                                       uint8_t *p_data,
...
zsa_result_t usb_cmd_stream_register_cb(usbcmd_t usbcmd, usb_cmd_stream_cb_t *frame_ready_cb, void *context);

zsa_result_t usb_cmd_stream_start(usbcmd_t usb_handle, size_t payload_size);

zsa_result_t usb_cmd_stream_stop(usbcmd_t usb_handle);
