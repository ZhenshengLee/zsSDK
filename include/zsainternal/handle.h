...
#ifndef ZSA_INTERNAL_HANDLE_H
#define ZSA_INTERNAL_HANDLE_H
...
/* ZSA_DECLARE_CONTEXT creates type matched C functions to create, destroy and get the context. The create and destroy
...
#define ZSA_DECLARE_CONTEXT(_public_handle_name_, _internal_context_type_)                                             \
...
ZSA_DECLARE_CONTEXT(foo_t, context_t );
