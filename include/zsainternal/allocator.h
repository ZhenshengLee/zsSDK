 ...
 * is no longer needed.
 *
 * \return ::ZSA_RESULT_SUCCEEDED if the callback function was set or cleared successfully. ::ZSA_RESULT_FAILED if an
 ...
 *
 * This function should not be called until all outstanding \ref zsa_capture_t objects are freed.
 */
